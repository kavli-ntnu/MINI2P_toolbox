...
filename='C:\Recordings\99643\Ladder climbing\Imaging\20211128\Climbing20211128_00003.tif';
...
if length(Dimention)<=3
    ...
    PlaneMark=ones(size(ImageStack_corrected,3),1);
...
for i=1:1:size(ImageStack_corrected,3)
    ImageStack_corrected(:,:,i)=imwarp(ImageStack_corrected(:,:,i),TransformMatrix{1,1}{PlaneClosest(i),1},'OutputView',imref2d(size(ImageStack_corrected(:,:,1))));
