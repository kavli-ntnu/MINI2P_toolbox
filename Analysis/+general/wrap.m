...
function y = wrap(x,range)
    ...
    if nargin < 1,
      error('Incorrect number of parameters (type ''help <a href="matlab:help helpers.wrap">helpers.wrap</a>'' for details).');
    end
